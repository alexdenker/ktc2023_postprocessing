...
def create_phantoms(min_inclusions=1, max_inclusions = 4, max_iter=80, distance_between=25):
    ...
    while(len(circle_list) < num_forms):
        object_type = np.random.choice(["polygon", "circle", "rectangle"], p=[0.4,0.3,0.3])
